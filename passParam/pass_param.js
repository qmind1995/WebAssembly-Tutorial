...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'pass_param.wast';
  var wasmBinaryFile = 'pass_param.wasm';
  var asmjsCodeFile = 'pass_param.temp.asm.js';
...
var real___Z16addOneForAllAttsPh = asm["__Z16addOneForAllAttsPh"]; asm["__Z16addOneForAllAttsPh"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___Z16addOneForAllAttsPh.apply(null, arguments);
};
...
Module["asm"] = asm;
var __Z13printIntParama = Module["__Z13printIntParama"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z13printIntParama"].apply(null, arguments) };
var __Z16addOneForAllAttsPh = Module["__Z16addOneForAllAttsPh"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z16addOneForAllAttsPh"].apply(null, arguments) };
var __Z7addNumsPfi = Module["__Z7addNumsPfi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z7addNumsPfi"].apply(null, arguments) };
